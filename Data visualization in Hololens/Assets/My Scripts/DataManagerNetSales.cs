...
namespace Assets.My_Scripts
{
    ...
    public class DataManagerNetSales : DataManager
    {

        public string urlDivision = "netsales/getdivision";
        public string urlBrand = "netsales/getbrand";
        public string urlDivisionTop = "topvendor/getnetdiv";
        public string urlBrandTop = "topvendor/getnetbrand";
        bool fetchDataComplete = false;
        bool dataAssigned = false;
        string FileNameD = "DataManagerNetSalesDiv";
        string FileNameB = "DataManagerNetSalesBrand";
        string FileNameDTop = "DataManagerNetSalesDivTop";
        string FileNameBTop = "DataManagerNetSalesBrandTop";
        ...
        public IEnumerator fetchData()
        {
            ...
            GraphController.NetDivData = null;
            GraphController.NetDivData = JsonUtility.FromJson<EntityDataArray>("{\"entity\":" + data + "}");
            ...
            GraphController.NetBrandData = null;
            GraphController.NetBrandData = JsonUtility.FromJson<EntityDataArray>("{\"entity\":" + data + "}");
            ...
            GraphController.NetDivTopData = null;
            GraphController.NetDivTopData = JsonUtility.FromJson<TopVendorDataArray>("{\"topVen\":" + data + "}");
            ...
            GraphController.NetBrandTopData = null;
            GraphController.NetBrandTopData = JsonUtility.FromJson<TopVendorDataArray>("{\"topVen\":" + data + "}");

            /*=====================================================
             * End : Top Vendor For Baseline PopUp Data Fetch
             ======================================================*/

            if (GraphController.NetDivData == null || GraphController.NetBrandData == null)
            ...
            //Debug.Log("Data:" + GraphController.NetDivData.entity[0].EntityName);
            //Debug.Log("Data:" + GraphController.NetBrandData.entity[0].EntityName);
        }//function : fetchData()
        ...
        public void assignNamesToBaselines()
        {
            ...
            for (int xid = 0; xid < graph.totalXAxis; xid++)
            {
                ...
                {
                    graph.XAxis[xid].baseLine[i].GetComponent<SubBaseLineManager>().setName(GraphController.timelineName[xid][i]);
        ...
        public void assignValuesToBars()
        {
            ...
            if (zid == 0)
                Data = GraphController.NetDivData;
            else
                Data = GraphController.NetBrandData;
                    ...
                    if (zid == 0)
                    {
                        if (graph.ShowYear == 15)
                            info = "Top 3 Vendors [2015]\n" +
                                   "- - - - - - - - - - - - - - - -\n" +
                                   "1 : " + GraphController.vendorName[GraphController.NetDivTopData.topVen[i].vid15[0]] + "\n" +
                                   "2 : " + GraphController.vendorName[GraphController.NetDivTopData.topVen[i].vid15[1]] + "\n" +
                                   "3 : " + GraphController.vendorName[GraphController.NetDivTopData.topVen[i].vid15[2]] + "\n" +
                                   "- - - - - - - - - - - - - - - -\n";
                        else
                            info = "Top 3 Vendors [2016]\n" +
                                   "- - - - - - - - - - - - - - - -\n" +
                                   "1 : " + GraphController.vendorName[GraphController.NetDivTopData.topVen[i].vid16[0]] + "\n" +
                                   "2 : " + GraphController.vendorName[GraphController.NetDivTopData.topVen[i].vid16[1]] + "\n" +
                                   "3 : " + GraphController.vendorName[GraphController.NetDivTopData.topVen[i].vid16[2]] + "\n" +
                                   "- - - - - - - - - - - - - - - -\n";
                    }
                    else
                    {
                        if (graph.ShowYear == 15)
                            info = "Top 3 Vendors [2015]\n" +
                                   "- - - - - - - - - - - - - - - -\n" +
                                   "1 : " + GraphController.vendorName[GraphController.NetBrandTopData.topVen[i].vid15[0]] + "\n" +
                                   "2 : " + GraphController.vendorName[GraphController.NetBrandTopData.topVen[i].vid15[1]] + "\n" +
                                   "3 : " + GraphController.vendorName[GraphController.NetBrandTopData.topVen[i].vid15[2]] + "\n" +
                                   "- - - - - - - - - - - - - - - -\n";
                        else
                            info = "Top 3 Vendors [2016]\n" +
                                   "- - - - - - - - - - - - - - - -\n" +
                                   "1 : " + GraphController.vendorName[GraphController.NetBrandTopData.topVen[i].vid16[0]] + "\n" +
                                   "2 : " + GraphController.vendorName[GraphController.NetBrandTopData.topVen[i].vid16[1]] + "\n" +
                                   "3 : " + GraphController.vendorName[GraphController.NetBrandTopData.topVen[i].vid16[2]] + "\n" +
                                   "- - - - - - - - - - - - - - - -\n";
                    }
